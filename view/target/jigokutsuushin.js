"use strict";window.oncontextmenu=function(){return false;};window.onload=function(){htmlinit();main();};function main(){let head=getOrCreate("head");new append(head).tag("title",undefined,"地獄通信").favicon("/assets/jigokutsuushin/icon.png");let body=getOrCreate("body");new modify(body).setStyle("background","#050006");playopening();}
